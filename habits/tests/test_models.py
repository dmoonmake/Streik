...
def test_habit_streak_preserved_when_paused():
    ...
    Completion.objects.create(completion_habit_id=habit, completion_date=now - timedelta(days=3))
    Completion.objects.create(completion_habit_id=habit, completion_date=now - timedelta(days=4))
...
def test_habit_inactive_resets_streak_and_deletes_today():
    ...
    Completion.objects.filter(completion_habit_id=habit, completion_date=now).update(completion_deleted=True)
    habit.habit_last_streak = 0
    habit.habit_status = "inactive"
    habit.save()

    assert habit.get_current_streak() == 0
    assert not habit.completions.filter(completion_date=now, completion_deleted=False).exists()
...
def test_weekly_habit_streak_respects_week_cycle():
    ...
    Completion.objects.create(completion_habit_id=habit, completion_date=now)
    Completion.objects.create(completion_habit_id=habit, completion_date=now - timedelta(days=7))
    Completion.objects.create(completion_habit_id=habit, completion_date=now - timedelta(days=14))
...
def test_weekly_streak_skipped_week():
    ...
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 1, 1))
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 1, 15))  # skipped Jan 8
...
def test_weekly_streak_multiple_completions_same_week():
    ...
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 2, 2))  # same week
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 2, 8))  # next week
...
def test_monthly_habit_streak_respects_month_cycle():
    ...
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 1, 10))
...
def test_monthly_streak_resets_after_missed_month():
    ...
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 1, 20))
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 2, 10))
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 4, 1))  # March skipped
...
def test_monthly_streak_restart_after_break():
    ...
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 2, 6))

    # Skipped March

    # Restart
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 4, 7))
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 5, 2))
...
def test_monthly_streak_with_multiple_same_month_completions():
    ...
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 3, 5))
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 3, 15))

    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 4, 5))
...
def test_report_returns_longest_streak():
    habit = Habit.objects.create(habit_name="Read", habit_occurrence="daily", habit_status="active")
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 1, 1))
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 1, 2))
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 1, 4))  # Break
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 1, 5))
    Completion.objects.create(completion_habit_id=habit, completion_date=datetime(2025, 1, 6))
